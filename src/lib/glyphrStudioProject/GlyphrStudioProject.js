...
export default class GlyphrStudioProject {
  ...
  constructor(vnum, vname){
    this.projectsettings = {
      ...
      'initialversion': '',  // project number version that survives upgrades
      'versionname': '',  // project number version
    ...
    this.projectsettings.version = vnum? vnum : '2.0.0',    // project version
    this.projectsettings.initialversion = vnum? vnum : '2.0.0',  // project number version that survives upgrades
    this.projectsettings.versionname = vname? vname : 'Version 2 Alpha'  // project number version
  }
