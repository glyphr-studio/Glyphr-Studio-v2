export default {
    ...
    redrawCanvas(selectedGlyph) {
        ...
        let glyph, path;
        if (selectedGlyph && window.GlyphrStudio && window.GlyphrStudio.currentProject && window.GlyphrStudio.currentProject.glyphs && window.GlyphrStudio.currentProject.glyphs[selectedGlyph]) {
    ...
    generateCanvasGrid() {
        console.log('generateCanvasGrid');
